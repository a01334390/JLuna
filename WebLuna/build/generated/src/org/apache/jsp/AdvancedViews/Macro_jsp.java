...
import AdvancedElements.MacroView;
import BasicElements.Cliente;
import DatabaseManager.Handler;
import java.time.LocalDate;
import java.time.format.DateTimeFormatter;

public final class Macro_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (!session.getAttribute("currentPrivilegeLevel").equals("admin")) {
      ...
      out.write("        <title>Macroview</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      ...
      out.write("            <br>\n");
      out.write("            <br>\n");
      out.write("            <div class=\"notebookhd\"><h1 class=\"whitetxt\">Welcome to the macroview </h1></div>\n");
      out.write("            \n");
      out.write("                \n");
      out.write("            \n");
      out.write("            \n");
...
if (semana.length != 0) { 
      out.write("\n");
      out.write("    <h3 class=\"centeredform\">Entregas de esta semana</h3>\n");
...
for (int i = 0; i < semana.length; i++) {
 ...
 String tabla[] = semana[i].split(", ");
      ...
      out.write("\n");
      out.write("        <h3 class=\"centeredform\">Entregas atrasadas</h3>\n");
      out.write("        <table border=\"1\">\n");
      out.write("            <thead>\n");
      out.write("                <tr class=\"centeredform whitetxt\">\n");
      out.write("                    <th>id</th>\n");
...
for (int i = 0; i < atrasados.length; i++) {
 ...
 String tabla[] = atrasados[i].split(", ");
      ...
      out.write("            </tbody>\n");
      out.write("        </table> \n");
      out.write("        <h3 class=\"centeredform\">Mejores clientes</h3>\n");
      out.write("        <table border=\"1\">\n");
      out.write("            <thead>\n");
      out.write("                <tr class=\"centeredform whitetxt\">\n");
      out.write("                    <th>ID de la orden</th>\n");
      out.write("                    <th>Primer nombre</th>\n");
      out.write("                    <th>Segundo nombre</th>\n");
      out.write("                    <th>Prioridad</th>\n");
...
for (int i = 0; i < clientes.length; i++) {
 ...
 String tabla[] = clientes[i].split(", ");
      ...
      out.write("            </tbody>\n");
      out.write("        </table>\n");
      out.write("        <h3 class=\"centeredform\">Materiales que se estan acabando</h3>\n");
      out.write("        <table border=\"1\">\n");
      out.write("            <thead>\n");
      out.write("                <tr class=\"centeredform whitetxt\">\n");
...
for (int i = 0; i < material.length; i++) {
 ...
 String tabla[] = material[i].split(", ");
      ...
      out.write("            </tbody>\n");
      out.write("        </table> \n");
      out.write("        <h3 class=\"centeredform\">Cuadernos que se estan acabando</h3>\n");
      out.write("        <table border=\"1\">\n");
      out.write("            <thead>\n");
      out.write("                <tr class=\"centeredform whitetxt\">\n");
      out.write("                    <th>Nombre</th>\n");
