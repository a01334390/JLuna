...
import AdvancedElements.OrderOrders;
import AdvancedElements.OrderClients;

public final class priorityorders_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if (!session.getAttribute("currentPrivilegeLevel").equals("admin")) {
      ...
      out.write("        <title>Prioridad de ordenes</title>\n");
      out.write("    </head>\n");
      out.write("    <body>\n");
      ...
      out.write("            <br>\n");
      out.write("            <br>\n");
      out.write("            <div class=\"notebookhd\"><h1 class=\"whitetxt\">Priority orders</h1></div>\n");
      out.write("    </body>\n");
      out.write("    \n");
      out.write("    <h3 class=\"centeredform\">Pedidos por fecha</h3>\n");
...
for (int i = 0; i < semana.length; i++) {
 ...
 String tabla[]= semana[i].split(", "); 
      ...
      out.write("                </tbody>\n");
      out.write("            </table>\n");
      out.write("                <h3 class=\"centeredform\">Pedidos por prioridad</h3>\n");
      out.write("            <table border=\"1\">\n");
      out.write("                <thead>\n");
      out.write("                    <tr class=\"centeredform whitetxt\">\n");
      out.write("                        <th>Fecha</th>\n");
